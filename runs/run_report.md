...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | --- | ---: |
| gpu-rtx-6000-ada-run-0 | NVIDIA RTX 6000 Ada Generation | 1024 | 2 | 16 | 32 | unknown* | No config snapshot available; reported metrics match the 1024 / 2x16 setup | 5955.26 | 15.8170 | 8.6266 |  | 0.775096 |
...
\* `gpu-rtx-6000-ada-run-0` does not include `config_snapshot.yaml` or `manifest.json`, so `train.gradient_checkpointing` could not be verified from the available artifacts.
